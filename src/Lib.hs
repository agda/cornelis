...
import Cornelis.Highlighting (getLineIntervals, highlightBuffer, lookupPoint)
    ...
    when (fromOneIndexed @Int pos >= 50) $ do
        ...
        case lookupPoint li pos of
            ...
            Just (Pos l c) -> do
                ...
                for_ ws $ flip Compat.window_set_cursor (fromOneIndexed (oneIndex l), fromZeroIndexed c)
